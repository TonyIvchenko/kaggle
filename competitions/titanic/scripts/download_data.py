"""Download Titanic files with the Kaggle CLI."""
...
DEFAULT_FILES = ("train.csv", "test.csv", "gender_submission.csv")


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Download Titanic competition data.")
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Optional comma-separated file list (e.g. train.csv,test.csv,gender_submission.csv).",
    )
    parser.add_argument(
        "--all-files",
        action="store_true",
