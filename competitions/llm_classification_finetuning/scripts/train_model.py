"""Train and evaluate LLM Classification Finetuning baseline model."""
...
from competitions.llm_classification_finetuning.models.baseline import (  # noqa: E402
    COMPETITION_SLUG,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train LLM Classification Finetuning baseline model.")
...
def main() -> None:
    ...
    for row in holdout_metrics["strategy_metrics"]:
        print(f"  - {row['name']}: accuracy={row['accuracy']:.6f}")
