"""Download Deep Past Initiative: Machine Translation files with the Kaggle CLI."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Download Deep Past Initiative data.")
...
def build_download_error_message(competition: str, output: str) -> str:
    ...
    if "403" in output and "Forbidden" in output:
        return (
            ...
            "Your credentials are probably valid, but this competition is still blocked for your account.\n\n"
            "Check these in order:\n"
            "  - Open https://www.kaggle.com/competitions/"
            f"{competition} in the browser.\n"
            "  - Click Join / Accept Rules if prompted.\n"
            "  - Complete identity verification at https://www.kaggle.com/settings if requested.\n"
